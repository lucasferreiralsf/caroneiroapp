...
export class UserScalarWhereInput {
    ...
    primaryPhoneNumber?: number;
    primaryPhoneNumber_not?: number;
    primaryPhoneNumber_in?: number[];
    primaryPhoneNumber_not_in?: number[];
    primaryPhoneNumber_lt?: number;
    primaryPhoneNumber_lte?: number;
    primaryPhoneNumber_gt?: number;
    primaryPhoneNumber_gte?: number;
    secondaryPhoneNumber?: number;
    secondaryPhoneNumber_not?: number;
    secondaryPhoneNumber_in?: number[];
    secondaryPhoneNumber_not_in?: number[];
    secondaryPhoneNumber_lt?: number;
    secondaryPhoneNumber_lte?: number;
    secondaryPhoneNumber_gt?: number;
    secondaryPhoneNumber_gte?: number;
    email?: string;
    email_not?: string;
    email_in?: string[];
    email_not_in?: string[];
